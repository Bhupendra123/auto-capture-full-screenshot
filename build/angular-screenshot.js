...
var screenshot = function screenshot() {
   var screenshotController = function screenshotController($scope, $element, $compile, $timeout, $window) {
	  ...
	  var downloadFullImgUrl = function downloadFullImgUrl(callback) {
      ...
      var getElementSelector = function getElementSelector() {
         return self.target ? angular.element(self.target) : $element;
      };
      ...
      var setHightLevelZindex = function setHightLevelZindex() {
         var maxZindex = 999999;//findMaxZindex();
	 ...
	 var left = elementSelector[0].offsetLeft;
         var top = elementSelector[0].offsetTop;
         setHightLevelZindex();
